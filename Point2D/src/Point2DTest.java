...
public class Point2DTest {
	...
	public void testToString(){
		...
		assertEquals("coord1 = '(6, -14)'", "(6, -14)", coord1);
		
		Point2D p2 = new Point2D(0, 0);
		String coord2 = p2.toString();
		assertEquals("coord2 = '(0, 0)'", "(0, 0)", coord2);
		
		Point2D p3 = new Point2D(777777, 777777);
		String coord3 = p3.toString();
		assertEquals("coord3 = '(777777, 777777)'", "(777777, 777777)", coord3);
	}
